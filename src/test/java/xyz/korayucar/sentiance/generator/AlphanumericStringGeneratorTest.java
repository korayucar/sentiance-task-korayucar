...
public class AlphanumericStringGeneratorTest {
    ...
    public void lines_PerformanceTest() throws Exception {
        RandomLineGenerator generator = new AlphanumericStringGenerator(ThreadLocalRandom.current() , 20);
        generator.lines().limit(50000).mapToInt(String::length).sum();
    }

    @Test
    public void lines_BigDataConsumed_TotalNumberOfCharactersCorrect() throws Exception {
        RandomLineGenerator generator = new AlphanumericStringGenerator(ThreadLocalRandom.current() , 20);
        assertEquals( 20 * 50000 , generator.lines().limit(50000).mapToInt(String::length).sum());
    }
